...
export const projects = [
    ...
    },
    {
        ...
        role: "Designed and built the frontend and the serverless API layer end-to-end - component architecture, Airtable data-fetching/caching, and Vercel functions and their security posture.",
        summary:
            "A production-ready real estate listings site built as a reusable client template, with per-client theming driven by environment variables. All property and agent data is pulled live from Airtable - no traditional database.",
        highlights: [
            ...
            "PII (personally identifiable information) stripping at the API boundary - internal-only fields (agent record links, owner name/email/phone) are explicitly stripped before a response ever leaves the server.",
    ...
    },
    {
        ...
        stack: ["React", "TypeScript", "GraphQL", "TypeORM", "PostgreSQL", "Auth0"],
        summary:
    ...
    },
    {
        ...
        summary:
            "Frontend work on a collaborative note-taking app: a live-rendered markdown editor, note sharing/permissions UI, and real-time updates as collaborators edit together.",
        highlights: [
            ...
            "Real-time UI updates - the editor and sidebar reflect concurrent edits and collaborator presence live over the team's WebSocket connection, without a manual refresh.",
            "Sharing/permissions UI - lets a note owner grant view or edit access per collaborator, reflecting the row-level access model the backend exposes.",
        ],
        images: [
    ...
    },
    {
        ...
        stack: ["C", "MPI"],
        summary:
            "A Gomoku-playing agent (15×15 board, 5-in-a-row to win) built as a distributed minimax search: the search tree is split across multiple MPI processes, with a master process dynamically handing out unexplored branches to idle workers.",
        highlights: [
    ...
    },
    {
        ...
        stack: ["Java"],
        summary:
            "A lossless compression tool for black-and-white bitmap images that represents an image not as pixels but as a deterministic finite automaton over a 4-symbol alphabet (Culik–Kari style automata-based compression).",
        highlights: [
